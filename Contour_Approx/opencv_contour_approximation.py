#
# Florian 06.04.2022
# test script for image contour approximation
...
ap.add_argument("-i", "--image", type=str, default="battery1.jpg",
...
# convert image to gray and apply threshold
...
# to demonstrate the impact of contour approximation loop
# over a number of epsilon sizes
for eps in np.linspace(0.001, 0.05, 5):
